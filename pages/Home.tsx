      ...
      <div className="bg-white w-full max-w-sm rounded-3xl overflow-hidden shadow-2xl animate-in zoom-in-95 duration-200">
        ...
        <div className="p-6">
          ...
          <button 
            ...
            className={`w-full py-4 rounded-xl font-bold text-white shadow-lg active:scale-[0.98] transition-all flex items-center justify-center space-x-2 ${
              mode === 'stake' ? 'bg-brand-600 hover:bg-brand-700 shadow-brand-500/30' : 'bg-gray-800 hover:bg-gray-900 shadow-gray-500/30'
            }`}
          >
  ...
  return (
    <div className="flex flex-col bg-gray-50 min-h-screen pb-32">
        ...
        <div className="relative z-10 flex justify-between items-center mb-8">
          <div className="flex items-center space-x-3">
            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-brand-400 to-brand-600 p-0.5">
               <img src="https://picsum.photos/100/100" alt="Profile" className="w-full h-full rounded-full object-cover border-2 border-[#1a1b2e]" />
            </div>
            <div>
              <p className="text-gray-400 text-xs font-medium">환영합니다,</p>
              <h2 className="text-white font-bold text-lg leading-none">알렉스 게이머님</h2>
            </div>
          </div>
      ...
      <div className="px-5 -mt-6 relative z-20">
        <div className="grid grid-cols-2 gap-3">
          ...
          <button 
            ...
            className="col-span-2 relative h-40 rounded-[32px] overflow-hidden shadow-2xl shadow-brand-500/40 active:scale-[0.96] transition-all duration-300 group ring-4 ring-transparent hover:ring-brand-500/20"
          >
            {/* Background Gradient */}
          ...
          <button 
            ...
            className="bg-white rounded-[28px] p-5 shadow-sm border border-gray-100 relative overflow-hidden group hover:shadow-md transition-all active:scale-[0.98] flex flex-col justify-between h-36"
          >
      ...
      <div className="mt-8">
        ...
        <div className="flex overflow-x-auto no-scrollbar px-5 pb-4 space-x-3 snap-x">
           {[
